...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { descricao: @sport.descricao, nome: @sport.nome, regra: @sport.regra } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { descricao: @sport.descricao, nome: @sport.nome, regra: @sport.regra } }
